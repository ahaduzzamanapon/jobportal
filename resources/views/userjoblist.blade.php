                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($Keywordspl)
                                            <input name="Keywords" value="{{ $Keywordspl }}" class="form-control" type="text" placeholder="Keywords">
                                            @else
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="location" class="selectize-filter">
                                                ...
                                                @if($locationspl)
                                                <option value="">{{ $locationspl}}</option>
                                                @else <option value="">Location</option>
                                                @endif
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="catname" class="selectize-filter">
                                                @if($catnamespl)
                                                <option value="">{{ $catnamespl}}</option>
                                                @else <option value="">Categories</option>
                                                @endif
