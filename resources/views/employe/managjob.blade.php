                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ '/employ/viewjob/'.$data->id }}" class="btn btn-primary my-1">View</a>

                                                    <a href="{{ '/employ/delletjob/'.$data->id }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger my-1">Delete</a>
