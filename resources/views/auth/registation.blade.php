        ...
        <div class="signin-signup">
          ...
          <form action="{{route('login')}}" method="post" class="sign-in-form">
            ...
            <span class="invaild">
              ...
              <p style="color: rgb(252, 1, 1)">Please sellect your Roll****</p>

              <label  for="radio1">
                <input type="radio"  id="radio1" name="optradio" value="user" checked>Candidate
              </label> <div class="mtauto ">

              </div>


              <label  for="radio2">
                <input type="radio"  id="radio2" name="optradio" value="employ">Employee
              </label>
          ...
          <form action="{{route('adduser')}}" method="post" class="sign-up-form">
