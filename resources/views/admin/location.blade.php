                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <a href="{{url('/admin/addlocation')}}" class="btn btn-primary">Add Location</a>
                                    </div>
                                    <!-- table hover -->
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$data->location}}</td>
                                                    <td>
                                                        <a href="{{ '/admin/editlocation/'.$data->id }}" class="btn btn-success my-1">Edit</a>
                                                        <a href="{{ '/admin/delletlocation/'.$data->id }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger my-1">Delete</a>
