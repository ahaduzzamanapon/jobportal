                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-start">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit CATAGORISE</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                @endif
                                    <form method="post" action="{{ url('/admin/updatesettings') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="my-input">Site Name</label>
                                            <input id="my-input" class="form-control" type="text" name="sitename"  value="{{ $data->sitename }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="my-input">Titel name</label>
                                            <input id="my-input" class="form-control" type="text" name="titelname"  value="{{ $data->titelname }}">
                                        </div>
