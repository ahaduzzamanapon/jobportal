                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-start">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Location Managment</a></li>
                    ...
                    <div class="row" id="table-hover-row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @endif
                                    <form method="post" action="{{ url('/admin/updatelocation/'.$data->id) }}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="my-input">cat name</label>
                                            <input id="my-input" class="form-control" type="text" name="location"  value="{{ $data->location }}">
                                        </div>
