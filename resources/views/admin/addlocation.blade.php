...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <a href="{{url('/admin/location')}}" class="btn btn-primary">Show Location</a>
                                    </div>
                                    @if ($errors->any())
                                        ...
                                        @endif
                                    <form method="post" action="{{ url('/admin/locationstor') }}">
                                        @csrf
                                        <div class="form-group">
                                            <label class=" my-2" for="my-input">Location Name</label>
                                            <input id="my-input" class="form-control my-3" type="text" name="location" placeholder="Enter Location">
                                        </div>
    ...
    <sc
ript src="{{asset('assets/js/bootstrap.bundle.min.js')}}"></script>
